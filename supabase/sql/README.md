...
## שדה תאריך לידה ונתוני דמו

| קובץ | מתי להריץ |
|------|-----------|
| `12_add_trainee_birth_date.sql` | אחרי 06 — מוסיף עמודת `birth_date` לטבלת trainees (לימי הולדת קרובים). |
| `13_demo_data_seed.sql` | אופציונלי — אחרי 10, 11, 12. מזין נתוני דמו: 4987 חניכות, 567 צוות, תקציבים, קבלות, פעילויות, הודעות. דורש משתמש דמו. |
